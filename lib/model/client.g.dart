...
void _clientSerialize(
  ...
  writer.writeString(offsets[1], object.telephone);
}
...
Client _clientDeserialize(
  ...
  object.telephone = reader.readStringOrNull(offsets[1]);
  return object;
}
...
extension ClientQueryFilter on QueryBuilder<Client, Client, QFilterCondition> {
  ...
  QueryBuilder<Client, Client, QAfterFilterCondition> telephoneIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
  ...
  QueryBuilder<Client, Client, QAfterFilterCondition> telephoneIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'telephone',
      ));
  ...
  QueryBuilder<Client, Client, QAfterFilterCondition> telephoneEqualTo(
    String? value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Client, Client, QAfterFilterCondition> telephoneGreaterThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Client, Client, QAfterFilterCondition> telephoneLessThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Client, Client, QAfterFilterCondition> telephoneBetween(
    String? lower,
    String? upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Client, Client, QAfterFilterCondition> telephoneStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Client, Client, QAfterFilterCondition> telephoneEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Client, Client, QAfterFilterCondition> telephoneContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
  ...
  QueryBuilder<Client, Client, QAfterFilterCondition> telephoneMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
  ...
  QueryBuilder<Client, Client, QAfterFilterCondition> telephoneIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'telephone',
        value: '',
  ...
  QueryBuilder<Client, Client, QAfterFilterCondition> telephoneIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'telephone',
        value: '',
...
extension ClientQuerySortBy on QueryBuilder<Client, Client, QSortBy> {
  ...
  QueryBuilder<Client, Client, QAfterSortBy> sortByTelephone() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'telephone', Sort.asc);
    });
  }

  QueryBuilder<Client, Client, QAfterSortBy> sortByTelephoneDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension ClientQuerySortThenBy on QueryBuilder<Client, Client, QSortThenBy> {
  ...
  QueryBuilder<Client, Client, QAfterSortBy> thenByTelephone() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'telephone', Sort.asc);
    });
  }

  QueryBuilder<Client, Client, QAfterSortBy> thenByTelephoneDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'telephone', Sort.desc);
    });
  }
...
extension ClientQueryWhereDistinct on QueryBuilder<Client, Client, QDistinct> {
  ...
  QueryBuilder<Client, Client, QDistinct> distinctByTelephone(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension ClientQueryProperty on QueryBuilder<Client, Client, QQueryProperty> {
  ...
  QueryBuilder<Client, String?, QQueryOperations> telephoneProperty() {
    return QueryBuilder.apply(this, (query) {
